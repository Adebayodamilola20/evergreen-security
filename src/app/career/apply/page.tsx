        ...
        <section className="py-20 bg-gray-50 min-h-[60vh] flex items-center justify-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">
              Thank you for your interest in joining Police Guard Services, Inc. Our recruitment team will review your application and contact you within 5-7 business days.
            </p>
          </motion.div>
        </section>
      </>
    ...
    <>
      <section className="relative pt-40 pb-20 bg-navy overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            PGS Online Application for Employment
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input type="text" required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                <div>
                  ...
                  <select required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900">
                ...
                <div>
                  ...
                  <input type="text" required placeholder="000-00-0000" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Home Phone *</label>
                  <input type="tel" required placeholder="(000) 000-0000" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div>
                  ...
                  <input type="tel" placeholder="(000) 000-0000" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Email Address *</label>
                  <input type="email" required placeholder="your@email.com" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
              </div>

              <div className="mt-6">
                <label className="block text-sm font-semibold text-gray-700 mb-2">Home Address *</label>
                <input type="text" required placeholder="123 Main Street" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                  ...
                  <input type="text" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                ...
                <div>
                  ...
                  <input type="date" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Number of Guard Years *</label>
                  <input type="number" required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                  ...
                  <input type="text" placeholder="e.g. 45000" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900">
              ...
              <div className="mt-6">
                ...
                <textarea rows={3} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900 resize-none" placeholder="List your availability..." />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl border border-gray-100">
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900 resize-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Do you have a Valid Driver&rsquo;s License? *</label>
                  <select required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900">
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
            ...
            <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl border border-gray-100">
              ...
              <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="age" value="Yes" required className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">Yes</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="age" value="No" className="w-5 h-5 text-accent" />
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="workAuth" value="Yes" required className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">Yes</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="workAuth" value="No" className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">No</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex gap-6 items-center">
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="appliedBefore" value="Yes" required className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">Yes</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="appliedBefore" value="No" className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">No</span>
                      </label>
                    </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex gap-6 items-center">
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="workedBefore" value="Yes" required className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">Yes</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="workedBefore" value="No" className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">No</span>
                      </label>
                    </div>
                    <input type="date" className="px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900" />
                ...
                <div className="p-4 bg-red-50 rounded-xl border border-red-100">
                  <div className="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="convicted" value="Yes" required className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">Yes</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="convicted" value="No" className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">No</span>
                      </label>
                    </div>
                  </div>
                  <textarea rows={2} className="w-full mt-4 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900 resize-none" placeholder="Provide details if applicable..." />
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-green-50 rounded-xl border border-green-100">
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="background" value="Yes" required className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">Yes</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="background" value="No" className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">No</span>
                    </label>
                  </div>
                </div>
              ...
              <div key={num} className="bg-white rounded-2xl p-8 md:p-10 shadow-xl border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" required={num === 1} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">State *</label>
                    <select required={num === 1} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900">
                      <option value="">Select State</option>
                      {states.map((s) => <option key={s} value={s}>{s}</option>)}
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="tel" required={num === 1} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Supervisor&rsquo;s Name *</label>
                    <input type="text" required={num === 1} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Salary *</label>
                    <input type="text" required={num === 1} placeholder="e.g. 40000" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-xl">
                  <div className="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name={`contact-${num}`} value="Yes" required={num === 1} className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">Yes</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name={`contact-${num}`} value="No" className="w-5 h-5 text-accent" />
                        <span className="text-gray-700">No</span>
                      </label>
                    </div>
                  </div>
                ...
                <div className="mt-6">
                  ...
                  <textarea rows={3} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900 resize-none" />
                </div>
              </div>
            ))}
            ...
            <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl border-2 border-accent/20">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 rounded-xl bg-accent flex items-center justify-center text-white font-bold text-lg">
                  10
                </div>
              ...
              <div className="space-y-6">
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
                  <p className="text-gray-700 leading-relaxed">
                    <span className="font-bold">Certification:</span> I certify that all answers above are truthful. I hereby certify that the above information is correct and I authorize Police Guard Services, Inc. to check any records which they may need to verify my employment, credit, driving, medical treatment, or any other records relating to my employment suitability.
                  </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="affirmation" value="Yes" required className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">Yes</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="affirmation" value="No" className="w-5 h-5 text-accent" />
                      <span className="text-gray-700">No</span>
                    </label>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input type="date" required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all text-gray-900" />
                </div>
              </div>
            ...
            >
              <button
                type="submit"
                className="px-16 py-5 text-lg font-bold bg-accent text-white rounded-xl transition-all duration-300 hover:opacity-90 transform hover:-translate-y-2 shadow-xl"
