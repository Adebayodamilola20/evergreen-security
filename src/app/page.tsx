        ...
        <div className="container-custom px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="inline-block bg-orange-100 text-orange-600 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold tracking-wide">
                📸 Gallery Showcase
              </div>
              ...
              <Link
                href="/gallery"
                className="inline-flex items-center justify-center bg-highlight hover:bg-highlight/95 text-primary font-bold px-8 rounded-full text-lg h-14 transition-all hover:scale-105 shadow-md"
              >
                View Gallery
            ...
            >
              <div className="w-1/2 mt-12">
                <div className="rounded-2xl overflow-hidden shadow-2xl h-[360px] sm:h-[400px] relative group border border-gray-100">
                  <img
                    src="/assets/Gemini_Generated_Image_2l1i1i2l1i1i2l1i-DkjYzYZr.png"
                    alt="Security Team"
              ...
              <div className="w-1/2">
                <div className="rounded-2xl overflow-hidden shadow-2xl h-[360px] sm:h-[400px] relative group border border-gray-100">
                  <img
                    src="/assets/Gemini_Generated_Image_brqnxqbrqnxqbrqn-qJVmIH_v.png"
