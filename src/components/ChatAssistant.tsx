...
const WELCOME_TEXT = `Hello and welcome to ${COMPANY.name}. How may I help you with our security services, the training academy, or careers today?`;
...
export default function ChatAssistant() {
  ...
  // Seed a welcome message the first time the chat is opened.
  useEffect(() => {
    if (chatOpen && messages.length === 0) {
      setMessages([{ id: Date.now(), text: WELCOME_TEXT, sender: "ai" }]);
    }
